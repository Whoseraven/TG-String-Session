...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [ @String_SGen_Bot ](tg://openmessage?user_id=7577853954) \nA Bot By @Kirito_Bots")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/Whosekirito_Support'),
                InlineKeyboardButton('Developer', url='https://t.me/whosekirito')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/Kirito_Bots/15'),
            ]
        ]
    )
